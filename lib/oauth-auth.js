...
exports.configureOauth = function (app,config) {
    ...
    app.post('/auth/oauth/login',rawParser,function(req, res){
        var clientID = '20170830061623854-E5A8-B2FABDC35';
        var redirctToUrl = req.session.oldurl;
        var redirectToLogin = 'true';
        var idpbaseUrl = 'https://uuidptest.c.citic/idp/profile/SAML2/Redirect/GLO';
        var entityId = clientID;
        var access_token = req.sesseion['access_token'];

        //call applicationLogout
        ...
        //validate sessions destroy
        console.log("sessions:", sessions);
        //call idpLogout
        var params={};
        params['redirctToUrl']= redirctToUrl;
        params['redirectToLogin']= redirectToLogin;
        params['entityId']= clientID;
        idpLogoutUrl = idpbaseUrl + "?" + querystring.stringify(params);
        this._request("GET",idpLogoutUrl,{},"",access_token,callback);
